...
const requestUrladdbyId = 'http://localhost:8080/api/v1/products/add/';
class Inventory extends React.Component {
  ...
  populate(evt){
    ...
    if(this.state.proid.length != 0){
      ...
      if(this.state.brand.length === 0 || this.state.quantity.length === 0 || this.state.pricefrom.length === 0 || this.state.priceto.length === 0){
            ...
            <Col xs={12} md={8} lg={8} className="border-right">
              ...
              <div className="addproducts">
                ...
                <fieldset>
                  ...
                  <Addproductbydesc handlecategory={this.handlecategory} handlebrand={this.handlebrand} handlequantity={this.handlequantity}  
